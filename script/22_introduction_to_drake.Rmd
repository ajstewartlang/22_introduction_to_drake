...
You can download the slides in .odp format by clicking [here](../slides/introduction_to_drake.odp) and in .pdf format by clicking on the image below. 
&nbsp;&nbsp;

<center>

[![Link to Drake slides](../images/drake.png){width=75%}](../slides/introduction_to_drake.pdf)

</center>

&nbsp;&nbsp;

Add Miles McBain talk

https://youtu.be/jU1Zv21GvT4
